...
const UserEducationDepartment = require('../models/EmployeeEducationDepartment')
...
class RefreshController {
    ...
    async checkTokenEduDep(req, res) {
        const { id } = req.body;

        const user = await UserEducationDepartment.findOne({ _id: id });
        console.log("user", user)
        ...
        const email = user.email
        const CPF  = user.cpf
        const positionAtEducationDepartment = user.positionAtEducationDepartment
        const type = user.type
        const idEducationDepartment = user.idEducationDepartment
        //const id_matter = user.id_matter
        //const id_class = user.id_class
        //
        /*const usersWithSameCpf = await positionAtEducationDepartment.find({ cpf: user.cpf });
